...
from PyQt5.QtCore import pyqtSlot, Qt, PYQT_VERSION_STR, QT_VERSION_STR, QSettings, QTimer, QFile, QFileInfo, \
    QByteArray, QVariant
from PyQt5.QtWidgets import QMainWindow, QDockWidget, QLabel, QDockWidget, QListWidget, QApplication, \
    QFrame, QAction, QActionGroup, QMessageBox, QSpinBox, QFileDialog, QInputDialog
