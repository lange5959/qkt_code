...
# try:
#     GetFilename="/"+path.split('/')[-1]
# except:
#         pass  
# DIRECTORY= path - ord(GetFilename) 
# print DIRECTORY
...
class ControllerLibraryUI(QtWidgets.QDialog):
    ...
    def save(self):
        ...
        try:
            GetFilename=path.split('/')[-1]
            GetsPrefixname=GetFilename.split('.')[0]
        except:
            pass
        print GetFilename
        self.saveNameField.setText(GetsPrefixname)
