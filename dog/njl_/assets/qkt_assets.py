...
class MainWidget(QtWidgets.QMainWindow):
    ...
    def buildUI(self):
        ...
        editMirrorVerticalAction = self.createAction(
            "Mirror &Vertically", self.fileNew,
        ...
        self.info_label = QtWidgets.QLabel((u"label - ..."))
        dock4.setWidget(self.info_label)
