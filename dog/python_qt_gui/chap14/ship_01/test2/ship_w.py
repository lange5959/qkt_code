...
class Ship(object):
    ...
    def __cmp__(self, other):  # 排序用
        return QString.localAwareCompare(self.name.toLower(),
                                         other.name.toLower())
    ...
    def inCountryOwnerOrder(self):
        def compare(a, b):
            if a.country != b.country:
                return QString.localAwareCompare(a.country, b.country)
            if a.owner != b.owner:
                return QString.localAwareCompare(a.owner, b.owner)
            return QString.localAwareCompare(a.name, b.name)
