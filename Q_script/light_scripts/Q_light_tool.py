...
class LightWidget(QtWidgets.QWidget):
    ...
    def buildUI(self):
        ...
        layout.addWidget(self.intensityLin)
        ...
        layout.addWidget(self.shadowcolorBtn)
        ...
        layout.addWidget(self.emitDiffuse)
        ...
        layout.addWidget(self.emitSpecular)
        ...
        layout.addWidget(self.light_connect)
        ...
        if self.light.hasAttr('aiAngle'):
            ...
            layout.addWidget(self.aiangleLin)
        layout.addStretch()
    ...
    def build_ar_UI(self):
        ...
        layout.addWidget(self.ai_shadowcolorBtn)
